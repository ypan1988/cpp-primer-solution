...
** Exercise 7.1
   #+BEGIN_QUOTE
   Write a version of the transaction-processing program from ง 1.6 (p. 24)
   using the ~Sales_data~ class you defined for the exercises in ง 2.6.1 (p.
   72).
   #+END_QUOTE
...
** Exercise 7.3
   #+BEGIN_QUOTE
   Revise your transaction-processing program from ยง 7.1.1 (p. 256) to use these
   members.
   #+END_QUOTE
...
** Exercise 7.7
   #+BEGIN_QUOTE
   Rewrite the transaction-processing program you wrote for the exercises in ง
...
** Exercise 7.9
   ...
   the exercises in ง 7.1.2 (p. 260).
   #+END_QUOTE
